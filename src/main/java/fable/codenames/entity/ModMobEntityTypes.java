...
import fable.codenames.entity.mob.MyHostileEntity;
import fable.codenames.entity.passive.MyPassiveEntity;
...
public enum ModMobEntityTypes {
    ...
    CROWN(CrownEntity.createAttributes(), FabricEntityTypeBuilder.create(SpawnGroup.MISC, CrownEntity::new).dimensions(EntityDimensions.fixed(0.6f, 0.6f)).trackRangeBlocks(64).trackedUpdateRate(1).build());
