...
public enum ModBlockEntityTypes {
    ...
    TEAM_CHAT_BLOCK_ENTITY(FabricBlockEntityTypeBuilder.create(TeamChatBlockEntity::new, ModBlocks.TEAM_CHAT.getBlock()).build()),
    CLICK_BUTTON_BLOCK_ENTITY(FabricBlockEntityTypeBuilder.create(ClickButtonBlockEntity::new, ModBlocks.CLICK_BUTTON.getBlock(), ModBlocks.START_BUTTON.getBlock()).build());
